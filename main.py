...
from api.routes import factory_control, realtime, format_control, skill_control, knowledge_control, telemetry_control, master_control, benchmark_control, crosswalk_control, mcp_control, standard_control
