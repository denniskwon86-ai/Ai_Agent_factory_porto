...
SHOTS = [
    ...
    ("업무데이터준비-준비도", ADMIN, "업무 데이터 준비>#원료 도입"),
    ("시나리오-관리자", ADMIN, "시나리오 시뮬레이션"),
    ("의사결정안건-관리자", ADMIN, "의사결정 안건"),
    #: [I-4 7 / H-4] 운영 승격 — 파일럿 동선의 마지막 칸
    ("운영승격-관리자", ADMIN, "운영 승격"),
    #: ★ 목록만 찍으면 「고를 수 있다」만 본 것이다. 골라서 **다섯 검사**를 본다.
    ("운영승격-점검", ADMIN, "운영 승격>#원료 입고 현황 앱"),
