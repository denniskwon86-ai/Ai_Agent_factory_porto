...
수집 회귀        420건 통과 (131초) · 네트워크 0회 · LLM 0회   ← ECOS·스케줄러 포함
tsc -b           0건
...
⚠️⚠️ **T3 를 다시 돌려야 한다.** 위 결과는 커밋 `4862927b3` 시점이고, 그 뒤 스케줄러 묶음
  (`b654ea2a4` · 신규 30건)이 들어왔다. 수집 회귀 420건은 통과했지만 **전체 스위트로는
