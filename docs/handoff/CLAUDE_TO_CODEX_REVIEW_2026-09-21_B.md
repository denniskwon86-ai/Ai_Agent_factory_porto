...
> 🔴 **[2026-09-21 정정]** 이 문서의 §4 한 줄이 준비도를 「실제 증거」라고 불렀습니다.
> **그렇게 부를 수 없습니다**(DEP-R3). 정정 내용과 후속 보완은
> `CLAUDE_DEP_R1R4_REMEDIATION_2026-09-21.md` 를 함께 보십시오.
> Codex 회신: `CODEX_REVIEW_DEP_P1_P2_2026-09-21_B.md` — **CHANGES_REQUESTED · 선별 재사용.**
...
| 결정 #9 「GitHub success + 실제 serving 증거 둘 다」 | ~~`serving_readiness` 가 그 «실제 증거» 쪽입니다~~ **[2026-09-21 정정 · DEP-R3]** 그렇게 부를 수 없습니다. 이것은 **읽기 전용 준비도 «판정 초안»이고 실제 관측 공급자가 붙어 있지 않습니다** — 역할은 부르는 쪽이 준 문자열, digest 는 탐침의 환경변수, 공유 저장소는 표식 «선언» 까지입니다 |
