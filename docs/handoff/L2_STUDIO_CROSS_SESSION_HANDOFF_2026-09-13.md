...
> 2026-09-15 이후 작업 재개는 [Claude Code 시작 안내](CLAUDE_CODE_START_HERE_2026-09-15.md)를 먼저 읽는다. 이 문서의 데이터 복원·키 비공개 전달 제한은 유지되지만 B5/B6 당시 진척·다음 작업은 최신 안내로 갱신됐다.09-13 스냅샷이 이후 데이터까지 자동 동기화하는 것은 아니다.
