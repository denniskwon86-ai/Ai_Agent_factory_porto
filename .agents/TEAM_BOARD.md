...
- 다음/담당/조건: 회사 전환 시 Studio 닫기, new/draft/kit/release/mega 대상 연결. 담당 문서 충돌(통합계획·B6 는 「App 은 Codex 단독」, 시작 안내 §6-A5 는 「Claude Code 로 이관」)은 사용자가 「Codex 미작업」을 확인해 진행했다.
